  ...
  return (
    <section id="about" className="py-24 bg-muted/10 relative overflow-hidden">
      ...
      <div className="absolute top-1/2 left-0 -translate-y-1/2 -translate-x-1/4 opacity-[0.02] pointer-events-none select-none">
        <h2 className="text-[20vw] font-bold tracking-tighter uppercase leading-none">Aesthetic Logic</h2>
      </div>
      ...
      <div className="container mx-auto max-w-5xl px-6 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
          <div className="lg:col-span-4 sticky top-24 space-y-8">
            ...
            >
              <div className="relative aspect-[3/4] rounded-2xl overflow-hidden mb-8 shadow-[0_0_40px_rgba(var(--color-primary),0.15)] group border border-primary/20">
                ...
                <div className="absolute inset-0 border-[10px] border-primary/5 opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none" />
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-3">
                  <Badge variant="secondary" className="rounded-full px-3 bg-primary/10 text-primary border-primary/20 hover:bg-primary/20 transition-colors cursor-default">視覺直覺</Badge>
                  <Badge variant="secondary" className="rounded-full px-3 bg-primary/10 text-primary border-primary/20 hover:bg-primary/20 transition-colors cursor-default">工程思維</Badge>
                </div>
                <div className="flex items-center gap-3">
                  <Badge variant="secondary" className="rounded-full px-3 bg-primary/10 text-primary border-primary/20 hover:bg-primary/20 transition-colors cursor-default">心理學洞察</Badge>
                </div>
              </div>
            </motion.div>
          </div>
          ...
          <div className="lg:col-span-8 space-y-12">
            ...
            >
              <h3 className="text-2xl font-bold mb-4 text-primary/90 flex items-center gap-3">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {[
                ...
                >
                  <Card className="bg-background/40 border border-primary/10 hover:border-primary/30 transition-all duration-500 shadow-sm group relative overflow-hidden">
                    <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-transparent via-primary/40 to-transparent translate-x-[-100%] group-hover:translate-x-[100%] transition-transform duration-1000" />
